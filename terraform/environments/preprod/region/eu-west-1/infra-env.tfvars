...
replay_dynamodb_table_arn   = "arn:aws:dynamodb:eu-west-1:653551970210:table/a206104-aaa-replay-dynamodb-preprod"
...
audit_logger_lambda_arn     = "arn:aws:lambda:eu-west-1:653551970210:function:a206104-aaa-auditing-lambda-preprod"
stream_enabled              = true
...
alarms = {
  "GuissApiCritical" = {
      ...
      "alarm_actions"             = [
          ...
          "arn:aws:sns:eu-west-1:653551970210:a206104-aaa-support-topic-preprod"
      ]
      "ok_actions"                = [
          "arn:aws:sns:eu-west-1:653551970210:compass-alarm-notification",
          "arn:aws:sns:eu-west-1:653551970210:a206104-aaa-support-topic-preprod"
