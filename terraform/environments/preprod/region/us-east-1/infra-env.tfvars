...
routing_api_table_name      = "a206104-aaa-routing-api-preprod-table"
...
replay_dynamodb_table_arn   = "arn:aws:dynamodb:us-east-1:653551970210:table/a206104-aaa-replay-dynamodb-preprod"
# API-Gateway
...
audit_logger_lambda_arn= "arn:aws:lambda:us-east-1:653551970210:function:a206104-aaa-auditing-lambda-preprod"
stream_enabled = true
...
alarms = {
  "GuissApiCritical" = {
      ...
      "alarm_actions"             = [
          ...
          "arn:aws:sns:us-east-1:653551970210:a206104-aaa-support-topic-preprod"
      ]
      "ok_actions"                = [
          "arn:aws:sns:us-east-1:653551970210:compass-alarm-notification",
          "arn:aws:sns:us-east-1:653551970210:a206104-aaa-support-topic-preprod"
      ...
      "tags"                      = {
        ...
        "tr:service-name" = "a206104-aaa-template-api-preprod"
      }
  }
}
