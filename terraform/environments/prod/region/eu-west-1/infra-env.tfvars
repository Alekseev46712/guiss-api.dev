...
routing_api_table_name      = "a206104-aaa-routing-api-prod-table"
...
replay_dynamodb_table_arn   = "arn:aws:dynamodb:eu-west-1:898084984877:table/a206104-aaa-replay-dynamodb-prod"
...
certificate_arn                  = "arn:aws:acm:us-east-1:898084984877:certificate/e8ae8779-d41a-4cff-8d04-62ab937c8aea"
production_stage_name            = ""
target_hosted_zone_name          = "aaa-prod.aws-int.thomsonreuters.com"
type                             = "A"
...
audit_logger_lambda_arn= "arn:aws:lambda:eu-west-1:898084984877:function:a206104-aaa-auditing-lambda-prod"
stream_enabled = true
...
alarms = {
  "GuissApiCritical" = {
      ...
      "threshold"                 = "1"
      "alarm_actions"             = [
        "arn:aws:sns:eu-west-1:898084984877:compass-alarm-notification"
      ]
      "ok_actions"                = [
          "arn:aws:sns:eu-west-1:898084984877:compass-alarm-notification",
          "arn:aws:sns:eu-west-1:898084984877:a206104-aaa-support-topic-prod"
      ]
      ...
      "tags"                      = {
        ...
        "tr:service-name" = "a206104-aaa-template-api-prod"
      }
  }
}
