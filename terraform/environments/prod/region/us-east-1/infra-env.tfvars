...
replay_dynamodb_table_arn   = "arn:aws:dynamodb:us-east-1:898084984877:table/a206104-aaa-replay-dynamodb-prod"
...
audit_logger_lambda_arn     = "arn:aws:lambda:us-east-1:898084984877:function:a206104-aaa-auditing-lambda-prod"
stream_enabled              = true
...
alarms = {
  "GuissApiCritical" = {
      ...
      "threshold"                 = "1"
      "alarm_actions"             = [
          "arn:aws:sns:us-east-1:898084984877:compass-alarm-notification",
          "arn:aws:sns:us-east-1:898084984877:a206104-aaa-support-topic-prod"
      ]
      "ok_actions"                = [
          "arn:aws:sns:us-east-1:898084984877:compass-alarm-notification",
          "arn:aws:sns:us-east-1:898084984877:a206104-aaa-support-topic-prod"
