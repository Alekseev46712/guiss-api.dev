...
replay_dynamodb_table_arn   = "arn:aws:dynamodb:us-east-1:653551970210:table/a206104-aaa-replay-dynamodb-qa"
...
audit_logger_lambda_arn= "arn:aws:lambda:us-east-1:653551970210:function:a206104-aaa-auditing-lambda-qa"
stream_enabled = true
...
alarms = {
  "GuissApiCritical" = {
      ...
      "alarm_actions" = [
        ...
        "arn:aws:sns:us-east-1:653551970210:a206104-aaa-support-topic-qa"
      ]
      "ok_actions" = [
        "arn:aws:sns:us-east-1:653551970210:compass-alarm-notification",
        "arn:aws:sns:us-east-1:653551970210:a206104-aaa-support-topic-qa"
