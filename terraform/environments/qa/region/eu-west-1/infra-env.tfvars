...
routing_api_table_name      = "a206104-aaa-routing-api-qa-table"
...
replay_dynamodb_table_arn   = "arn:aws:dynamodb:eu-west-1:653551970210:table/a206104-aaa-replay-dynamodb-qa"
...
audit_logger_lambda_arn= "arn:aws:lambda:eu-west-1:653551970210:function:a206104-aaa-auditing-lambda-qa"
stream_enabled = true
...
alarms = {
  "GuissApiCritical" = {
      ...
      "alarm_actions" = [
        ...
        "arn:aws:sns:eu-west-1:653551970210:a206104-aaa-support-topic-qa"
      ]
      "ok_actions" = [
        "arn:aws:sns:eu-west-1:653551970210:compass-alarm-notification",
        "arn:aws:sns:eu-west-1:653551970210:a206104-aaa-support-topic-qa"
      ...
      "tags"                      = {
        ...
        "tr:service-name" = "a206104-aaa-template-api-qa"
      }
  }
}
